...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
if EBinput.Verbose == 2, fprintf('Please cite: Alschuler et al. (2013). Clin Neurophysiol, in press.\n'); end
...
% % %   EDplotText(2,1) = cellstr('Alschuler et al. (2013)');
% % %   EDplotText(3,1) = cellstr('Clin Neurophysiol');
